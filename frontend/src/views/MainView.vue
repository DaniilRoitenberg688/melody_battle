...
<template>
  ...
  <button class="position-fixed end-0 bottom-0 btn me-5 mb-5 text-center px-3 py-2 fs-5" @click="this.$router.push('/create-melody-battle')" style="color: black; background-color:rgba(0,255,255,0.98);">+</button>
</template>
